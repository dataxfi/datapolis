...
function energywebPools(address, amt, skipT0, skipT1, callT0, callT1) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, new Promise(function (res) { return (setTimeout(function () { res(""), 25; })); })];
                case 1:
                    _a.sent();
                    return [4, (0, subgraph_requests_1.uniswapV3Req)("https://ewc-subgraph-production.carbonswap.exchange/subgraphs/name/carbonswap/uniswapv2", address, amt, skipT0, skipT1, callT0, callT1)];
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4, (0, subgraph_requests_1.uniswapV2Req)("https://api.thegraph.com/subgraphs/name/uniswap/uniswap-v2", address, amt, skipT0, skipT1, callT0, callT1)];
                case 2: return [2, _a.sent()];
            }
        });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4, (0, subgraph_requests_1.uniswapV3Req)("https://bsc.streamingfast.io/subgraphs/name/pancakeswap/exchange-v2", address, amt, skipT0, skipT1, callT0, callT1)];
                case 2: return [2, _a.sent()];
            }
        });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4, (0, subgraph_requests_1.uniswapV3Req)("https://api.thegraph.com/subgraphs/name/solarbeamio/amm-v2", address, amt, skipT0, skipT1, callT0, callT1)];
                case 2: return [2, _a.sent()];
            }
        });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4, (0, subgraph_requests_1.uniswapV3Req)("https://api.thegraph.com/subgraphs/name/mtahon/uniswap-v3-rinkeby", address, amt, skipT0, skipT1, callT0, callT1)];
                case 2: return [2, _a.sent()];
            }
        });
    });
}
exports.rinkebyPools = rinkebyPools;
