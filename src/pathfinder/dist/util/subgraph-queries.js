...
function uniswapV2Query(address, amt, skipT0, skipT1, callT0, callT1) {
    ...
    var t0Match = "t0IsMatch: pairs(first:1000 skip:".concat(skipT0, " where:{token0_contains:\"").concat(address, "\", volumeUSD_gt:\"1\" reserve0_gt:\"").concat(amt, "\"}\n  ").concat(generalReq);
    var t1Match = "t1IsMatch: pairs(first:1000 skip:".concat(skipT1, " where:{token1_contains:\"").concat(address, "\", volumeUSD_gt:\"1\" reserve1_gt:\"").concat(amt, "\"}\n  ").concat(generalReq);
