    ...
    return (
        ...
        <div className="md:grid md:grid-cols-5">
            ...
            <div className="col-span-3 mt-3 md:mt-0">
                ...
                <input onWheel={ event => event.currentTarget.blur() } onKeyDown={(evt) => ["e", "E", "+", "-"].includes(evt.key) && evt.preventDefault()} type="number" className="h-full w-full rounded-lg bg-black text-4xl px-2 outline-none focus:placeholder-gray-200 placeholder-gray-500" placeholder="0.0" />
            </div>
        </div>
    </div>
    )
