        ...
        <div className="flex mt-16 w-full items-center mb-20">
            <div className="max-w-2xl mx-auto bg-primary-900 w-full rounded-lg p-4">
                <div className="md:grid md:grid-cols-5 bg-primary-800 p-4">
                    ...
                    <div className="col-span-3 flex justify-end mt-3 md:mt-0 bg-primary-900 rounded-lg p-2">
                        <div>
                            ...
                            <input onChange={(e) => updateNum(e.target.value)} onWheel={ event => event.currentTarget.blur() } onKeyDown={(evt) => ["e", "E", "+", "-"].includes(evt.key) && evt.preventDefault()} type="number" className="h-full w-full rounded-lg bg-primary-900 text-2xl px-2 outline-none focus:placeholder-type-200 placeholder-type-400 text-right" placeholder="0.0" />
                        </div>
                        <p className="text-type-300 text-2xl">
                            %
                        </p>
                    </div>
                </div>
                    ...
                    <div className="md:grid md:grid-cols-5 bg-primary-800 p-4">
                        ...
                        <div className="col-span-3 grid grid-cols-2 gap-4">
                            <div className="bg-primary-900 grid grid-flow-col gap-2 p-2 rounded-lg">
                                <div>
                                    <img src="http://via.placeholder.com/80x80" className="w-12 rounded-lg" alt="" />
                                </div>
                                <div>
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                    ...
                    <Button text="Approve" classes="w-full px-8 py-4 border border-primary-500 rounded-lg"></Button>
                    <Button text="Confirm withdrawal" classes="w-full px-8 py-4 border border-primary-500 rounded-lg"></Button>
                </div>          
            </div>
        </div>
    )
